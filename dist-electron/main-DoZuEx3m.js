...
function createBill(data) {
  ...
  try {
    const { recordBillPaymentTransactions } = require("./cashUpiTransactions");
...
`;
  ...
  ipcMain.handle("cashUpi:addTransaction", async (_, data) => {
    try {
      const { addCashUpiTransaction } = await import("./cashUpiTransactions-B_M0r78B.js");
  ...
  ipcMain.handle("cashUpi:getTransactions", async (_, type, transactionType, dateFrom, dateTo, limit, offset) => {
    try {
      const { getCashUpiTransactions } = await import("./cashUpiTransactions-B_M0r78B.js");
  ...
  ipcMain.handle("cashUpi:getTransactionById", async (_, id) => {
    try {
      const { getCashUpiTransactionById } = await import("./cashUpiTransactions-B_M0r78B.js");
  ...
  ipcMain.handle("cashUpi:getSummary", async (_, dateFrom, dateTo) => {
    try {
      const { getCashUpiSummary } = await import("./cashUpiTransactions-B_M0r78B.js");
  ...
  ipcMain.handle("cashUpi:getDailySummary", async (_, date) => {
    try {
      const { getDailyCashUpiSummary } = await import("./cashUpiTransactions-B_M0r78B.js");
  ...
  ipcMain.handle("cashUpi:updateTransaction", async (_, id, updates) => {
    try {
      const { updateCashUpiTransaction } = await import("./cashUpiTransactions-B_M0r78B.js");
  ...
  ipcMain.handle("cashUpi:recordBillPayment", async (_, billNumber, paymentMode, cashAmount, upiAmount) => {
    try {
      const { recordBillPaymentTransactions } = await import("./cashUpiTransactions-B_M0r78B.js");
